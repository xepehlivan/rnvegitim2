		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Eğitim 2 / oData",
									"targetURL": "#renovaegitim2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"renovaegitim2-display": {
								"semanticObject": "renovaegitim2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=renova.egitim2",
									"url": sap.ui.require.toUrl("renova/egitim2")
								}
							}
						}
					}
